...
########################################################################
vInfIn = vInfInEGA1
vInfOut = vInfOutEGA1[:,argmax(rPEGA2)]
bParams = computeBvInf(vInfIn,vInfOut,earth.mu)
bSTR = bParams[1].dot(bParams[0])
print('EGA1 vInfIn: ' + str(vInfIn))
print('EGA1 vInfIn (mag): ' + str(norm(vInfIn)))
print('EGA1 vInfOut: ' + str(vInfOut))
print('EGA1 vInfOut (mag): ' + str(norm(vInfOut)))
print('EGA1 B Vector: ' + str(bSTR))

########################################################################
# EGA2
########################################################################
vInfIn = vInfInEGA2[:,argmax(rPEGA2)]
vInfOut = vInfOutEGA2
bParams = computeBvInf(vInfIn,vInfOut,earth.mu)
bSTR = bParams[1].dot(bParams[0])
print('EGA2 vInfIn: ' + str(vInfIn))
print('EGA2 vInfIn (mag): ' + str(norm(vInfIn)))
print('EGA2 vInfOut: ' + str(vInfOut))
print('EGA2 vInfOut (mag): ' + str(norm(vInfOut)))
print('EGA2 B Vector: ' + str(bSTR))
